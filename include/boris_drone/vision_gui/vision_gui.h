...
#ifndef boris_drone_VISION_GUI_H
#define boris_drone_VISION_GUI_H
...
private:
  ...
  //! Callbacks
  void processedImageCb(const boris_drone::ProcessedImageMsg::ConstPtr processed_image);

  //! Translation to OpenCV format
  void convertMsgToAttributes(boris_drone::ProcessedImageMsg::ConstPtr msg);
...
#endif /* boris_drone_VISION_GUI_H */
